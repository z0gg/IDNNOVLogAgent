...
def get_status():
    ...
    return {"running":running,"package_version":"1.0.8-1009","fluent_bit_version":"5.0.9","destination":persistence.load_public(ETC)["collector_url"],"listener":"127.0.0.1:5514","buffer_bytes":buffer_bytes,"buffer_limit_bytes":134217728}
